                                ...
                                Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => Text(
                                      'P ${valueOrDefault(currentUserDocument?.walletBallance, 0).toString()}',
                                      style: FlutterFlowTheme.of(context)
                                          .displaySmall
                                          .override(
                                            fontFamily:
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: ToggleIcon(
                                              ...
                                              value: listViewTransactionsRecord
                                                  .debit,
                                              onIcon: FaIcon(
                                          ...
                                          Text(
                                            '- P ${listViewTransactionsRecord.amount.toString()}',
